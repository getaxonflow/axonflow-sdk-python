...
It reads one thing from each spec: for every schema under `components.schemas`, the names of its
`properties`.
...
`36e0e96b7e5c16626d394272b727b533f2b94a04`, the v11.0.0 candidate. The script drops descriptions,
types, paths and the `info` block; the full specs carry the platform's own licence statement
there, and this repository is MIT (`tests/test_license_metadata.py`).
